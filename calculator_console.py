...
def calcular_presupuesto_tilbury():
    ...
    try:
        ...
        guardar_en_historial(ingreso_bruto, ingreso_neto, inversion_colchon, educacion_herramientas, estilo_de_vida)
        print ("Datos guardados con exito en el historial")
    except ValueError:
